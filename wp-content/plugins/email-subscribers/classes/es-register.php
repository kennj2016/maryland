	...
	function widget( $args, $instance ) {
		...
		<div>
			<form class="es_widget_form" data-es_form_id="es_widget_form">
				...
				<?php } ?>
				<div class="es_textbox">
					<input placeholder="Email" type="text" id="es_txt_email" class="es_textbox_class" name="es_txt_email" onkeypress="if(event.keyCode==13) es_submit_page(event,'<?php echo $url; ?>')" value="" maxlength="225">
				</div>
				<div class="es_button ">
                    <a onClick="javascript:void(0); return es_submit_page(event,'<?php echo $url; ?>')"
                            id="es_txt_button" class="es_textbox_button es_submit_button business_btn subscribe">
